            ...
            <main className="">
                <div style={{ padding: "20px" }} >
                    <div className="container py-2  mt-4 mt-lg-5 " >
                        <h1 className="text-center mb-5 boldCh ">My Projects</h1>
                        <div className="row " >
                            {projects.map((project, index) => (
                                <div className="col-md-6 mb-4" key={index} >
                                    <div className="card shadow bg-black rounded-4 silverCard  " style={{ overflow: "hidden", position: "relative", minHeight: "430px" }}>
                                        <img
                                            src={project.image}
                                            alt={project.title}
